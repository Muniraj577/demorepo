                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" name="dob" class="form-control"
                                                               value="{{getFormattedDate('Y-m-d',$artist->dob)}}"
                                                               id="dob" readonly>
                                                    ...
                                                    <div class="col-md-8">
                                                        <select name="gender" class="form-control">
                                                            ...
                                                            @foreach(getConstants(\App\Enum\GenderEnum::class) as $gender)
                                                                <option value="{{$gender->value}}" @selected($artist->gender == $gender->value)>{{ucfirst(strtolower($gender->name))}}</option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" name="address" value="{{ $artist->address }}"
